// requires the the sortables jquery ui plugin and the selso sorting plugin and jquery.disable.text.select.pack
...
(function($){
	jQuery.fn.supercomboselect = function(settings){
		settings = jQuery.extend({
			...
			valuesEmptyLabel : 'There are no more values to select', // string to display when the there are no more values in the left
			selectedEmptyLabel : 'Select from the values on the left', // string to display when the there are no more values in the left
			defaultSearchBoxLabel : 'Filter your search', // string to display in the search text box...
		...
		this.each(function(i){
			...
			**********************************************************************/
			...
			combo += '<div class="supercomboselect_empty_msg supercomboselect_left_empty_msg">' + settings.valuesEmptyLabel + '</div>';
			...
			combo += '<div class="supercomboselect">';
			combo += '<div class="supercomboselect_empty_msg supercomboselect_right_empty_msg">' + settings.selectedEmptyLabel + '</div>';
			...
			**********************************************************************/
			if (settings.isSearchable){
				...
				searchBox
					.attr('placeholder', settings.defaultSearchBoxLabel)
					.keyup(function(e){
			...
			**********************************************************************/
			...
			function refreshLists(init){
				...
				$('.supercomboselect').css({overflowY:'hidden'}).css({overflowY:'auto'}).disableSelection();
