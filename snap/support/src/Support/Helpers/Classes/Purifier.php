...
namespace Snap\Support\Helpers\Classes;

/**
 * Laravel 5 HTMLPurifier package
 * Source originally from Mews\Purifier/Purifier.
 * Needed to make it HTML5 compatible.
 *
...
class Purifier
{
     ...
     */
    protected function addCustomDefinition(array $definitionConfig, HTMLPurifier_Config $configObject = null)
    {
        if (!$configObject) {
     ...
     */
    protected function addCustomAttributes(array $attributes, HTMLPurifier_HTMLDefinition $definition)
    {
     ...
     * @return HTMLPurifier_HTMLDefinition $definition
     */
    protected function addCustomElements(array $elements, HTMLPurifier_HTMLDefinition $definition)
    {
