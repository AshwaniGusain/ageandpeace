...
<snap-inline inline-template>
    <div is="{{ $form_component }}" id="snap-resource-form" inline-template>
        <div>
            ...
            <form id="snap-form" class="form form-{{ $module->handle() }}" ref="form" action="{{ $module->url('insert') }}" method="post">
                ...
                <div id="snap-main-footer" class="modal-footer bg-light" style="padding-left: 1.25rem; padding-right: 1.25rem;">
                    <div class="bg-light" role="toolbar" aria-label="Toolbar">
                        ...
                        <div class="btn-group mr-2" role="group" aria-label="Save & Close">
                            <input type="submit" name="save_close" id="btn-save-close" @click="$parent.closeModal()" class="btn btn-primary text-light" value="{{ trans('admin::resources.btn_save_and_close') }}">
                        </div>
                    </div>
                </div>
                ...
                <input type="hidden" name="__redirect__" id="__redirect__" value="edit_inline">
