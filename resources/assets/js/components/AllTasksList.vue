        ...
        <transition name="scale">
            <section class="mb-8" v-if="showProgress && percentComplete">
                <div class="container-fluid container-dashboard">
                    <div class="row">
                        <div class="col-12">
                            <h5> {{Math.round(percentComplete * 100)}}% Complete</h5>
                    ...
                    <div class="d-flex">
                        <div class="form-inline">
                            <div class="form-group mr-3">
                                ...
                                <select name="" id="" class="custom-select form-control ml-3" v-model="filter">
                        ...
                        <!--<div class="form-inline">-->
                            <!--<div class="form-group mr-3">-->
                                ...
                                <!--<select name="" class="custom-select form-control ml-3" v-model="filter">-->
                                    <!--<option selected value="remaining">Remaining Tasks</option>-->
                                    <!--<option value="completed">Completed Tasks</option>-->
                                    <!--<option value="all">All Tasks</option>-->
                                <!--</select>-->
                ...
                <div class="col">
                    <div class="list-group tasks-list mb-6">
                        <transition-group name="task-list" tag="div">
                            <task v-for="(task, index) in activeTasks"
                    ...
                    <slot v-if="activeTasks.length" name="after-tasks"></slot>

                    <p v-if="! activeTasks.length">Nothing here...</p>
                </div>
            </div>
        </div>
    </div>
...
<script>
  ...
  export default {
    ...
    props: ['initialTasks', 'showProgress'],
    ...
    methods: {
      ...
      dueDate({id, due_date}) {
        ...
        // for (let i = 0; i < this.tasks.length; i++) {
        //   if (this.tasks[i].id == id) {
        //     this.tasks[i].due_date = due_date
        //   }
        // }
      }
    }
